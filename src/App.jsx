  ...
  return (
   ...
   <About/>
    ...
    <section id='projects' className='w-full h-full bg-white '>
      ...
      <div className='flex justify-end'>
      <div className='w-[85%] h-screen  gradientbackground flex gap-7 justify-center items-center p-10 max-md:w-full max-md:flex-col'>
        <p className='text-6xl p-10 text-center quote '>
